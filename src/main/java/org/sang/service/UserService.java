...
public class UserService implements UserDetailsService {
    ...
    public List<User> getUserByPage(String keywords, Integer currentIndex, Integer pageSize) {
        List<User> list = userMapper.getUserByPage(keywords,currentIndex,pageSize);
        return list;
    }
    ...
    public List<User> getUserByKeywords(String keywords) {
        List<User> list = userMapper.getUserByKeywords(keywords);
        return list;
    }
